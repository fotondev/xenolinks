<div>
    <label class="relative inline-flex items-center cursor-pointer">
        <input wire:model="isChecked" type="checkbox"
            @if ($isChecked) checked @endif class="sr-only peer">
        <div
        ...
        <span class="ml-3 text-sm font-medium text-gray-900">Подтверден</span>
    </label>
</div>
